  ...
  return (
    <div className="container mx-auto mt-12 mb-12">
        <div>
            ...
            <p className="text-center text-gray-400">The majority have suffered alteration in some form, by injected humour, <br /> or randomised words which don't look even slightly believable. </p>
        </div>
      <Swiper
        spaceBetween={30}
        slidesPerView={3}
      ...
      >
        {persons?.map((person) => (
          <SwiperSlide className="grid grid-cols-3 gap">
